...
<main class="bg-white">
  ...
  <section class="w-full">
    ...
    <div class="relative w-full h-[350px] overflow-hidden">
      ...
      <img
        src="assets/images/background/bg-category.svg"
  ...
  <section class="max-w-6xl mx-auto px-6 py-12 space-y-10">
    ...
    <div class="max-w-[1200px] mx-auto">
      ...
      <div class="flex justify-between items-start mb-6">
        ...
        <div>
          ...
          <h2 class="text-[32px] font-bold text-[#1E1E1E]">
            Living Room Collection
          </h2>

          <p class="text-sm text-[#543A14] mt-6 leading-relaxed max-w-4xl">
            Create a warm and welcoming living space with our collection of modern sofas,
            coffee tables, TV cabinets, and decorative furniture. Designed to combine
            comfort and functionality, each piece helps you build a relaxing environment
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mt-8">
        ...
        <div class="rounded-[32px] overflow-hidden group">
          <img
            src="assets/images/categories/cat-1.svg"
            class="w-full h-auto transition duration-500 group-hover:scale-105">
        </div>

        <div class="rounded-[32px] overflow-hidden group">
          <img
            src="assets/images/categories/cat-2.svg"
            class="w-full h-auto transition duration-500 group-hover:scale-105">
        </div>

        <div class="rounded-[32px] overflow-hidden group">
          <img
            src="assets/images/categories/cat-3.svg"
            class="w-full h-auto transition duration-500 group-hover:scale-105">
        </div>
    ...
    <div class="relative w-full h-[340px] md:h-[380px] overflow-hidden">
      ...
      <div class="absolute inset-0 flex items-center justify-end px-6 md:px-14">
        ...
        <div class="max-w-[440px] text-right flex flex-col items-end">
    ...
    <div class="grid md:grid-cols-2 gap-16 items-center">
      ...
      <!-- Text -->
      <div>
        <h2 class="text-[32px] font-bold font-bold text-[#1E1E1E]">
          Bedroom Collection
        </h2>
      ...
      <!-- Image -->
      <img
        src="assets/images/categories/bedroom.svg"
        class="w-full max-w-[700px] ml-auto object-contain">
    ...
    <div class="grid md:grid-cols-2 items-stretch">
      ...
      <!-- Text -->
      <div class="bg-[#FFF8F0] flex flex-col justify-center items-center text-center px-10 md:px-14 py-10">
